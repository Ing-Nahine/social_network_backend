    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_private', models.BooleanField(default=False, verbose_name='Compte privé')),
                ('avatar', imagekit.models.fields.ProcessedImageField(blank=True, null=True, upload_to='avatars/', verbose_name='Avatar')),
                ('banner', imagekit.models.fields.ProcessedImageField(blank=True, null=True, upload_to='banners/', verbose_name='Bannière')),
                ('followers_count', models.PositiveIntegerField(default=0, verbose_name='Nombre de followers')),
                ('following_count', models.PositiveIntegerField(default=0, verbose_name='Nombre de suivis')),
                ('posts_count', models.PositiveIntegerField(default=0, verbose_name='Nombre de posts')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Créé le')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Modifié le')),
                ('last_active', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Dernière activité')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Créé le')),
                ('followed', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='followers', to=settings.AUTH_USER_MODEL, verbose_name='Suivi')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('fr', 'Français'), ('en', 'Anglais'), ('es', 'Espagnol')], default='fr', max_length=5, verbose_name='Langue')),
                ...
                ('show_birth_date', models.BooleanField(default=False, verbose_name='Afficher date de naissance')),
                ('allow_direct_messages', models.BooleanField(default=True, verbose_name='Autoriser messages directs')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Créé le')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Modifié le')),
        ...
        migrations.AddIndex(
            model_name='follow',
            index=models.Index(fields=['followed', 'created_at'], name='user_follow_followe_8937c1_idx'),
        ),
